...
* 下面是三种网络模块的过程图
  ...
  ![1537858948943](readme\FRRUs_网络表达图)
...
![1537865738935](readme\FRRUs_模块)

* 下面是FRRU模块的公式

  ![1537865958930](readme\FRRUs_模块对应的公式2)

* 下面是FRRU模块的反向传播

![1537865835830](readme\FRRUs_模块对应的公式)

* 对于上面公式的解读，可以看下面，公式中有些依赖于n，有些不依赖于n，这就是残差连接的优势，可以防止梯度下降。

![1537866433085](readme\FRRUs_模块反向传播公式解释)

* FRRN两种结构示例

![1537884482593](readme\FRRUs_两种架构)

* 损失函数

  ![1537885310484](readme\FRRUs_损失函数)
